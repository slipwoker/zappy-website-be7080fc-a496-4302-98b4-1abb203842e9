    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רפאל כהן קואצ'ר ומאמן מנטלי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'be7080fc-a496-4302-98b4-1abb203842e9',
                    name: data.name || '',
                    email: data.email || '',
